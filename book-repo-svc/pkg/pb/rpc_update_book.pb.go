...
func (x *UpdateBookRequest) GetPublisherId() string {
	if x != nil {
...
func (x *UpdateBookResponse) Reset() {
	*x = UpdateBookResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_update_book_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateBookResponse) Descriptor() ([]byte, []int) {
	return file_rpc_update_book_proto_rawDescGZIP(), []int{1}
}
...
var file_rpc_update_book_proto_rawDesc = []byte{
	...
	0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61,
	...
	0x61, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x72,
	0x49, 0x64, 0x22, 0x32, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6f, 0x6f, 0x6b,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x62, 0x6f, 0x6f, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x6f, 0x6f, 0x6b,
	0x52, 0x04, 0x62, 0x6f, 0x6f, 0x6b, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_rpc_update_book_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_rpc_update_book_proto_goTypes = []interface{}{
	(*UpdateBookRequest)(nil),  // 0: pb.UpdateBookRequest
	(*UpdateBookResponse)(nil), // 1: pb.UpdateBookResponse
	(*Book)(nil),               // 2: pb.Book
}
var file_rpc_update_book_proto_depIdxs = []int32{
	2, // 0: pb.UpdateBookResponse.book:type_name -> pb.Book
...
func file_rpc_update_book_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_update_book_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
